...
export function AIAvatar({
  ...
  return (
    <div
      dir={isRtl ? 'rtl' : 'ltr'}
      className="relative flex min-h-[22rem] flex-col overflow-y-auto rounded-2xl bg-gradient-to-b from-primary-50 via-white to-primary-50/80 text-primary-900 sm:min-h-[24rem]"
    >
      <div
        className={`absolute top-3 z-10 flex gap-1.5 sm:top-4 ${
      ...
      <div className="flex flex-1 flex-col justify-start px-5 pb-4 pt-14 sm:px-7 sm:pb-5 sm:pt-16">
        <div className="mx-auto max-w-sm text-center">
          ...
          <p className="mt-2 text-sm leading-relaxed text-primary-800">{copy.subtitle}</p>
        </div>
      ...
      <div className="mx-3 mb-3 flex items-center gap-2 rounded-xl bg-white px-3.5 py-2.5 shadow-sm ring-1 ring-primary-100/80 sm:mx-4 sm:mb-4">
        ...
        <span className="text-xs font-medium text-gray-700">
          {listening ? copy.listening : copy.ready}
        </span>
        {listening ? (
          <span
